...
from .travelling_scraper_class import TravellingScraperClass

class ScraperFactory:
    def get_scraper(self, platform, scroll_page_attempt = 5, homepage=None, proxy=None, hasSignIn=False, stockCodes=["Gaming Chair", "Gaming Headset"],account={"username": "diepbaothien10x@gmail.com", "password": "thien1"}, headless=False, maxQueueSize = 0, queuesNum = 2, timeRange = '01-01-2021 - 31-12-2024'):
        if platform == "finance":
            ...
            return TravellingScraperClass(homepage="https://www.booking.com/" if homepage == None else homepage
                                        ...
                                        , maxQueueSize=maxQueueSize
                                        , queuesNum=queuesNum
                                        , scroll_page_attempt=scroll_page_attempt)
        else:
